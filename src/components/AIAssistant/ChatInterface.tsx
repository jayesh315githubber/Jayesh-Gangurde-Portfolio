...
export default function ChatInterface({
  ...
  const interactivePrompts = [
    "👋 Hey there! I'm here to help you learn about Jayesh. Want to know about his projects or experience?",
    "💡 Curious about Jayesh's skills? I can tell you about his technical expertise and achievements!",
    "🚀 Ask me anything! I know all about Jayesh's work, education, and career journey.",
    "✨ I'm Jayesh's AI assistant! What would you like to know about him today?",
  ];
                ...
                >
                  ...
                  <div>
                    <h4 className="text-base sm:text-lg font-semibold text-foreground mb-1 sm:mb-2">
                      Hi! I'm Jayesh's AI Assistant
                    </h4>
                    <p className="text-xs sm:text-sm text-muted-foreground mb-3 sm:mb-4">
                      Ask me anything about Jayesh.
                    </p>
                  </div>
                  <SuggestedQuestions />
                </motion.div>
