...
export default function InteractiveTooltip({
        ...
        try {
          ...
          setTimeout(async () => {
            try {
              ...
              console.debug(
                "Could not play notification sound after retry:",
                retryError
              );
            }
          }, 300);
  ...
  return (
    <>
      ...
      >
        <div
          className="relative bg-gradient-to-br from-background to-muted border-2 border-primary/50 rounded-xl shadow-2xl p-3 sm:p-4 backdrop-blur-xl"
